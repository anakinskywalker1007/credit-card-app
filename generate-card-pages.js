...
<div class="page-wrapper">
  ...
  <div class="card-hero">
    <div class="card-hero-header">
      ...
      <div>
        <a href="#" class="apply-btn" rel="noopener sponsored">Apply Now →</a>
  ...
  <div class="content-section" style="text-align:center;padding:32px">
    ...
    <a href="#" class="apply-btn" style="font-size:15px;padding:14px 32px" rel="noopener sponsored">Apply Now →</a>
